...
public class RentalContractIDGenerator : ValueGenerator<string>
{
    private const string _prefix = "HDTX";

    [ThreadStatic] private static int _counter;

    private static DateTime _lastGeneratedDate;

    static RentalContractIDGenerator()
    {
        _counter = 1;
    ...
    public override string Next(EntityEntry entry)
    {
        ...
        return $"{_prefix}-{DateTime.Today:yyyyMMdd}{currentCounter:D4}";
    }
}